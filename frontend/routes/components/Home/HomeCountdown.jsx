...
var HomeCountdown = React.createClass({
	...
	componentDidMount: function() {
		...
		// var annimate = setInterval(() => {
		//   console.log(this.state.height);
		//   this.drawLine();
		//   if(this.state.height > 0.99)
		//     clearInterval(annimate);
		//   this.setState({height: this.state.height+0.001});
		// }, 2.5);
	},
	...
	render: function() {
		...
		return (
			<div className="HomeCountdown--wrapper1">
				<div id='masasLoaderContainer' style={{ position: 'relative', height: '300px', display: (this.props.user ? 'block' : 'none') }} className="HomeCountdown--wrapper2">
				...
				<div className="mobile-logo" style={{ display: (!this.props.user ? 'block' : 'none') }}>
